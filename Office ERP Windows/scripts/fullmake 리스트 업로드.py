...
SOURCE_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRzG4kGawePQdGxZB9CII2zfEJKV4Vgdp4Ux3MmiXgr9KFHSX00xdOPFQZ_YyxO46lc0Jq-lcA8AuS5/pub?output=csv"
...
def log(message: str):
    print(f"[FULLMAKE] {message}", flush=True)
