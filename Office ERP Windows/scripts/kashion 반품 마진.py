...
SOURCE_INPUT_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vR8u0gUG4p8eCXQWNdocqbeQZo1kGd-VKj59JhuhoP5pzL5HsOmrRUSX86HYBP7TQyMG12EF5b1xHBI/pub?output=csv"
...
def log(message: str):
    ...
    print(f"[KASHION 반품 마진 {elapsed:6.1f}s] {message}", flush=True)
...
def read_source_sheet(csv_text: str) -> pd.DataFrame:
    ...
    if df.empty:
        raise DataValidationError("업로드할 KASHION 반품 데이터가 없습니다.")
