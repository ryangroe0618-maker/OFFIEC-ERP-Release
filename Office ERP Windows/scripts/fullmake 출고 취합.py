...
SOURCE_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRzG4kGawePQdGxZB9CII2zfEJKV4Vgdp4Ux3MmiXgr9KFHSX00xdOPFQZ_YyxO46lc0Jq-lcA8AuS5/pub?gid=594145141&single=true&output=csv"
STORE_URLS = {
    "스퀘어원": [
...
WEB_APP_URL = "https://script.google.com/macros/s/AKfycbwTSCJHJx9LpgI84f0QkOfkHqumSXkzWNoJeQ5apDV7VME1mSPYNg5mazkrAtq3HExZxg/exec"
SPREADSHEET_ID = "1LAPastLgqVy87hLp_N8jSz9NBtjGxHWYP3T54VVOIuI"
TARGET_SHEET_NAME = "취합"
ROE_DIR = os.path.expanduser("~/Desktop/Roe")
LIST_DIR = os.path.join(ROE_DIR, "LIST")
EXCEL_BASENAME = "FULLMAKE 출고 내역"
...
def log(message: str):
    print(f"[FULLMAKE-출고] {message}", flush=True)
